...
public interface OrderRepository extends JpaRepository<Order,Long> {
    ...
    @Query("update Order o set o.orderStatus=:orderstatus ,o.updatedAt=CURRENT_TIMESTAMP, o.updatedBy=:updateBy where o.orderId=:orderId")
    @Transactional
    @Modifying
    int updateOrder(@Param("orderId") Long orderId,@Param("orderstatus") String orderStatus,@Param("updateBy") String updateBy);
